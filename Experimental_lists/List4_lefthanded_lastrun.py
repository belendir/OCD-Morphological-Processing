...
expName = 'List4'  # from the Builder filename that created this script
expInfo = {
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=1.0, method='sequential', 
        ...
        trialList=data.importConditions('/Users/zeynepbelendir/Desktop/List4.xlsx'),
    ...
    for thisTrial in trials:
        ...
        prime.setText(prime4
        )
        target.setText(target4
        )
        key_resp.keys = []
        key_resp.rt = []
        _key_resp_allKeys = []
