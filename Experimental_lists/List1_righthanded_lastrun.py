...
expName = 'List1'  # from the Builder filename that created this script
expInfo = {
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=1.0, method='sequential', 
        ...
        trialList=data.importConditions('/Users/zeynepbelendir/Desktop/List1.xlsx'),
